...
<div class="grid-x grid-padding-x">
    ...
    <div class="medium-3 medium-offset-1 cell item-extra">
        <h4>Files</h4>
        <a href="#" class="item-file">Link to other file type</a>
        <a href="#" class="item-file">Link to other file type</a>
        <h4>Tags</h4>
        ...
        <a href="#" class="tag button">tag</a>
        <h4>Collection</h4>
        <a href="#" class="collection">Collection Title</a>
        <h4>Citation</h4>
        <p class="ital">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur provident, cum nisi. </p>
    </div>
</div>
